...
class videoController:
    ...
    def detect(self):
        ...
        bodys = self.full_body_cascade.detectMultiScale(gray, scaleFactor=1.5, minNeighbors=2)
        profile_faces = self.profile_face_cascade.detectMultiScale(gray, scaleFactor=1.5, minNeighbors=2)
        ...
        if len(profile_faces) != 0:
            for (x,y,w,h) in profile_faces:
                center = (x + w//2, y + h//2)
                cv2.ellipse(self.frame, center, (w//2, h//2), 0, 0, 360, (255, 0, 0))
